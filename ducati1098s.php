    ...
    <div class="products">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div>
              <img src="assets/images/ducati1098s1.png" alt="" class="img-fluid wc-image">
            </div>
            <br>
            <div class="row">
              ...
              <ul class="list-group list-group-flush">
               ...
               <li class="list-group-item">
                    <div class="clearfix">
                         ...
                         <strong class="pull-right">cinzenta/preta</strong>
                    </div>
               </li>
              </ul>
            </form>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="right-content">
                    <div class="col-md-3">
                      <img class="d-block w-auto"src="assets/images/ducati1098s2.png">
                     </div>
            </div>

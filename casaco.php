...
<div class="row">
    <div class="col">
       <a href="yzf%20r%20125.html"> <img class="d-block w-100" src="assets/images/cbr1000rr-r.png"></a>

    </div>
    <div class="col">
        <img class="d-block w-100" src="assets/images/cbr1000rr-r.png">
        ...
        <div class="down-content">
            <div class="row">
                <div class="col-lg-4 col-md-6" style="border-bottom:2px solid darkgray">
                    <a href="cbr1000rr-rdetalhes.html"><img src="assets/images/honda.jpg" class="img-fluid" style="border-bottom: 2px" alt=""></a>

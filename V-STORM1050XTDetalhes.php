...
<div class="products">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div>
                    <img src="assets/images/suzukivstrom1050xtAmostra´~.png" alt="" class="img-fluid wc-image">
                </div>
                <br>
                <div class="row">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="right-content">
                <div class="col-md-3">
                    <img class="d-block w-auto"src="assets/images/suzukivstrom1050xtAmostraN2.png">
                </div>
            </div>

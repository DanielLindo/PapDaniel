...
<div class="products">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div>
                    <img src="assets/images/yamaha-yzf%20r125Amostra.png" alt="" class="img-fluid wc-image">
                </div>
                <br>
                <div class="row">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <div class="clearfix">
                                ...
                                <strong class="pull-right">Honda cbr1000rr-r</strong>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item">
                            <div class="clearfix">
                                ...
                                <strong class="pull-right">0km</strong>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item">
                            <div class="clearfix">
                                ...
                                <strong class="pull-right">14,5cc</strong>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item">
                            <div class="clearfix">
                                ...
                                <strong class="pull-right">Vermelha</strong>
                            </div>
                        </li>
                    </ul>
                </form>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="right-content">
                <div class="col-md-3">
                    <img class="d-block w-auto"src="assets/images/yamaha-yzf%20r125AmostranN2.png">
                </div>
            </div>
